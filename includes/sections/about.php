<div id="about" class="about-section">
    <div class="container text-center">
        ...
        <ul class="technologies list-inline">
            <li><img src="<?= get_stylesheet_directory_uri()?>/assets/images/logo-bootstrap.svg" alt="Bootstrap"></li>
            <li><img src="<?= get_stylesheet_directory_uri()?>/assets/images/logo-angular.svg" alt="Angular"></li>
            <li><img src="<?= get_stylesheet_directory_uri()?>/assets/images/logo-html5.svg" alt="HTML5"></li>
            <li><img src="<?= get_stylesheet_directory_uri()?>/assets/images/logo-css3.svg" alt="CSS3"></li>
            <li><img src="<?= get_stylesheet_directory_uri()?>/assets/images/logo-less.svg" alt="Less"></li>
            <li><img src="<?= get_stylesheet_directory_uri()?>/assets/images/logo-jquery.svg" alt="jQuery"></li>
        </ul>
        ...
        <div class="items-wrapper row">
            <div class="item col-sm-4 col-xs-12">
                <div class="item-inner">
                    <div class="figure-holder">
                        <img class="figure-image" src="<?= get_stylesheet_directory_uri()?>/assets/images/figure-1.png" alt="image">
                    </div><!--//figure-holder-->
            ...
            <div class="item col-sm-4 col-xs-12">
                <div class="item-inner">
                    <div class="figure-holder">
                        <img class="figure-image" src="<?= get_stylesheet_directory_uri()?>/assets/images/figure-2.png" alt="image">
                    </div><!--//figure-holder-->
            ...
            <div class="item col-sm-4 col-xs-12">
                <div class="item-inner">
                    <div class="figure-holder">
                        <img class="figure-image" src="<?= get_stylesheet_directory_uri()?>/assets/images/figure-3.png" alt="image">
                    </div><!--//figure-holder-->
