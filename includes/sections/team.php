        ...
        <div class="members-wrapper row">
            <div class="item col-md-6 col-sm-6 col-xs-12">
                <div class="item-inner">
                    <div class="profile">
                        <img class="profile-image" src="<?= get_stylesheet_directory_uri()?>/assets/images/team-1.png" alt="Xiaoying Riley" />
                    </div>
            ...
            <div class="item col-md-6 col-sm-6 col-xs-12">
                <div class="item-inner">
                    <div class="profile">
                        <img class="profile-image" src="<?= get_stylesheet_directory_uri()?>/assets/images/team-2.png" alt="Tom Najdek" />
                    </div>
